...
# check_params="info/feat_dim info/ivector_dim info/left_context"
# check_params="$check_params info/right_context info/frames_per_eg info/final.ie.id cmvn_opts"
check_params="info/feat_dim info/left_context"
check_params="$check_params info/right_context info/frames_per_eg cmvn_opts"
...
cat ${args[0]}/cmvn_opts > $megs_dir/cmvn_opts || exit 1; # caution: the top-level nnet training
                                                          # script should copy this to its own dir.
